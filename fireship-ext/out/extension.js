...
function activate(context) {
    ...
    const disposable = vscode.commands.registerCommand('fireship-ext.start', () => {
        const panel = vscode.window.createWebviewPanel('chatView', 'AI Chat', vscode.ViewColumn.One, {
            enableScripts: true,
    ...
    function handleSwitchChat(panel, chatId) {
        activeChatId = chatId;
    ...
    async function streamResponse(panel, chatSession, botMessageId) {
        try {
    ...
    function updateBotMessage(chatSession, botMessageId, content, loading) {
    ...
    function sendMessageToWebview(panel, command, data) {
